...
function [wellList, foldername, ScalingFactor, csvHandler, Th] = CorticalNeuronsNucleusSkeletonnew (csvHandler) 
...
for(i=1:numel(allfiles))
    ...
    if(numel(ind) > 0)%
        ...
        nucleusPicBinary = bwareaopen(nucleusPicBinary,50);
        ...
        binaryimgNeurite = im2bw(imgballbackgroundNeurite,level);
