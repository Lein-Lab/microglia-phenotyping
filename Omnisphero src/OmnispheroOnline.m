...
function [neuronHandler TP FP TN] = EdgeFillNeuronsAlgorithm(selectedWell, yStartPos, yEndPos, xStartPos, xEndPos, save, optionHandler, ManualM, NucleusM, foldername)
