...
function Imagecutter_V5_8(Neuron_Channel, Oligo_Channel, Astro_Channel, foldername, neuronHandler, csvHandler, oligoHandler)
...
%result in no overlapp of migration areas (3101 equals 2000µM)
maxaddedlength = 3101;
    ...
    ind = strfind([foldername '/' allfiles(i).name],'NucleusBig.png');
        ...
        % Case 2: One sphere remained: s=1     
            if(0<s_L && s_L<2);
               ...
               newFile1 = regexprep(allfiles(i).name,'NucleusBig','NucleusBig_1','ignorecase');        
               imwrite(imagesphereresize1,[foldername1 '/' newFile1]);
               NucleusM = csvHandler.CellPosMatrix(allfiles(i).name);
               NucleusM1 = NucleusM(y_1:y_2,x_1:x_2);
               csvHandler.CellPosMatrix(newFile1) = NucleusM1;
            ...
            if(s_L >= 5);    
              ...
              if(d3_5<MinimumDistance);
               ...
               if(Neuron_Channel > 0)
                   ...
                   newFile5 = regexprep(allfiles(i).name,'NucleusBig','NeuriteBig_5','ignorecase');        
